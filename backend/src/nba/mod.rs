//! NBA: game handlers over the shared `scoreboard-espn` extraction, the
//! display-facing domain model, and its wire encoding. Responses
...
//! `firmware/src/scoreboard/nba.py`.
